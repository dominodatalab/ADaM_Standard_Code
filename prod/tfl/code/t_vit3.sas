...
* ____________________________________________________________________________
* PROGRAM HISTORY                                                         
*  27MAY2022             | Ugo Anozie          | Original version
\*****************************************************************************/
...
proc sort data = adamw.advs (where = (anl01fl='Y' and paramn =5))
          out = fromVS;
...
data Vitals;
  attrib rowlbl1   length = $200     label='Measure'
         rowlbl2   length = $200     label='Treatment'
		 rowlbl3   length = $200     label='Planned |n Relative time'
