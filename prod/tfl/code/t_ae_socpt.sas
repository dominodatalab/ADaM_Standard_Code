...
* Sponsor              : c999
* Study                : PILOT01
* Program              : t_ae_socpt.SAS
* Purpose              : Create table 14.5.2
* ____________________________________________________________________________
* DESCRIPTION                                                    
*                                                                   
* Input files: adsl adae
*              
* Output files: t_ae_socpt.rtf t_ae_socpt.sas7bdat
*               
...
/*    General options                                                        */
/*===========================================================================*/
%let dddatanam  = t_ae_socpt;                          /* Dataset name for dddata */
%let tflid      = 14.5.2;                              /* Table ID */
%let outname    = t_ae_socpt;                          /* Output file name */
...
data extrow (keep = aesoc aedecod soc_pt_disp trt_:); 
    ...
    if first.aesoc then do;
        if aesoc = 'ANY' then soc_pt_disp = 'Subjects with at least one TEAE';
...
title4 justify=c "Summary of Treatment-Emergent Adverse events by System Organ Class and Preferred term" ;
