...
* Purpose              : Create table 14.5.5
* ____________________________________________________________________________
* DESCRIPTION                                                    
*                                                                   
* Input files: adsl adae
*              
* Output files: t_ae_rel.rtf t_ae_rel.sas7bdat
*               
...
/*    General options                                                        */
/*===========================================================================*/
%let dddatanam  = t_ae_rel;                         /* Dataset name for dddata */
%let tflid      = 14.5.5;                           /* Table ID */
%let outname    = t_ae_rel;                         /* Output file name */
...
data extrow (keep = aesoc aedecod soc_pt_disp &byvar trt_0_npp trt_54_npp trt_81_npp); 
...
%p_mcrAddPageVar(dataset_in = final, dataset_out = final1, txt = soc_pt_disp, txt_col_width = 40, max_rows_per_page = 20)
...
/* Output the dddata */
data tflw.&dddatanam (drop = aesoc aedecod page indent
                      rename = (trt_0_npp = col1 trt_54_npp = col2 trt_81_npp = col3
                                soc_pt_disp = rowlbl1 &byvar = rowlbl2));
    set final1;
...
title4 justify=c "Summary of Treatment-Emergent Adverse events by System Organ Class, Preferred term and relationship to study treatment" ;
...
proc report data = final1 split = '~'
            ...
            column page
                   ...
                   ("|S={bordertopcolor = black bordertopwidth =2}" &byvar)
